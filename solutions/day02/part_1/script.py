...
def main(input_file_path: str, red_cubes: int, green_cubes: int, blue_cubes: int) -> int:
...
def test_main(test_file_path: str, red_cubes: int, green_cubes: int, blue_cubes: int, target_value: int):
    games_id_sum = main(
        test_file_path,
        red_cubes=red_cubes,
